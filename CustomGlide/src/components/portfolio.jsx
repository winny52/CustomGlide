...
const projects = [
  ...
  },
  {
    ...
    image: image5,
    link: "https://www.marcellanyc.com/", 
  },
  {
    name: "The Home T",
  ...
  return (
    <div className="container font-sans mx-auto py-12 pt-32 px-4 md:px-8">
      <div className="text-center mb-12">
        <h2 className="text-4xl font-bold  text-blue-800 mb-4">Sample Projects | Showcasing Our Best Work</h2>
        <p className="text-lg text-gray-700">At CustomGlide, we take pride in our work, and we are excited to showcase some of our best projects. Our portfolio includes a diverse range of projects, from small business websites to large-scale enterprise applications. Each project is a testament to our commitment to quality, innovation, and customer satisfaction.</p>
      </div>
