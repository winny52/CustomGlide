...
const DetailedProcess = () => {
  ...
  return (
    <div className="container  font-sans mx-auto p-6 pt-24 rounded-2xl">
      <h1 className='text-3xl font-bold  text-center mb-6 text-gray-900'>Our Process</h1>
      <h2 className="text-xl mb-8  text-blue-900 text-center font-semibold te">At CustomGlide, we believe that a well-defined process is the key to delivering successful projects. Our process is designed to ensure that we understand your needs, deliver high-quality solutions, and provide a seamless experience from start to finish.</h2>
      <div className="bg-gray-100 p-4 rounded-lg">
        <h3 className="text-xl font-bold mb-2">Step 1: Discovery</h3>
        <p className=' text-blue-900 text-center mb-4'>Understanding Your Goals and Requirements</p>
      ...
      <div className="bg-gray-100 p-4 rounded-lg">
        ...
        <p className=' text-blue-900 text-center mb-4'>Crafting a Detailed Project Roadmap</p>
      ...
      <div className="bg-gray-100 p-4 rounded-lg">
        ...
        <p className=' text-blue-900 text-center mb-4'>Creating a User-Friendly and Appealing Design</p>
      ...
      <div className="bg-gray-100 p-4 rounded-lg">
        ...
        <p className=' text-blue-900 text-center mb-4'>Building a Robust and Scalable Website</p>
      ...
      <div className="bg-gray-100 p-4 rounded-lg">
        ...
        <p className=' text-blue-900 text-center mb-4'>Ensuring Functionality and Performance</p>
      ...
      <div className="bg-gray-100 p-4 rounded-lg">
        ...
        <p className=' text-blue-900 text-center mb-4'>Deploying Your Site Live</p>
      ...
      <div className="bg-gray-100 p-4 rounded-lg">
        ...
        <p className=' text-blue-900 text-center mb-4'>Ongoing Support and Updates</p>
