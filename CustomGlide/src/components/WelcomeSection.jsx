...
const WelcomeSection = () => {
  ...
  return (
    <div className=" mt-2 mb-1 flex items-center justify-center font-sans bg-gray-100">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <div className="mt-8">
            {/* Trust badges */}
            <div className="flex flex-wrap justify-center items-center space-x-4 space-y-4 md:space-y-0 md:space-x-4">
            ...
            <div className="mt-8">
              <button
                onClick={handleClick}
                className="bg-orange-600 hover:text-white hover:bg-blue-800 text-white font-bold py-3 px-6 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2 focus:ring-offset-gray-100"
              >
                Get Started Today!
              </button>
            </div>
